...
function buildGameCanvas(){
	...
	for(var n=0; n<2; n++){
		...
		$.players['gamePlayer'+ n].color = '#000';
		...
		$.players['gameTimer'+ n].font = "18px bpreplaybold";
		$.players['gameTimer'+ n].color = '#000';
		...
		$.players['gamePlayerWin'+ n].color = '#000';
		$.players['gamePlayerWin'+ n].textAlign = "center";
		$.players['gamePlayerWin'+ n].textBaseline='alphabetic';
		$.players['gamePlayerWin'+ n].text = 0;
		$.players['gamePlayerWin'+ n].y += 8;
